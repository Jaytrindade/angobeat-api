...
PendingAdmin.query.byCheckCode = function (code, checked = false) {
  return this.where({ phoneNumberCode: code, checkedPhoneNumber: checked })
}

PendingAdmin.plugin(timeZone, {
  paths: ['createdAt', 'born'],
})

module.exports = model('PendingAdmin', PendingAdmin)
